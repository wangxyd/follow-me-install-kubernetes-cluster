...
- hosts: k8s-masters
  ...
  - name: copy kubelet.service
    template:
      ...
      dest: /usr/lib/system/kubelet.service
...
[admin@k8s-admin ~]$ ansible k8s-masters -m shell -a "systemctl status kubelet.service|grep -e Loaded -e Active"
```
+ 必须创建工作目录；
...
[admin@k8s-admin ~]$ kubectl certificate approve csr-sfn5g
certificatesigningrequest.certificates.k8s.io/csr-sfn5g approved
[admin@k8s-admin ~]$ kubectl get csr
NAME                                                   AGE     REQUESTOR                 CONDITION
